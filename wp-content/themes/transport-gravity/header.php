					...
					<div class="row align-items-center">
						...
						<div class="col-6 <?php echo esc_attr( $class ); ?>" id="primary-nav-container">
							<div id="navigation" class="wrap-nav d-none d-lg-block">
							    <nav id="site-navigation" class="main-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Primary Menu', 'transport-gravity' ); ?>">
							    	<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'transport-gravity' ); ?></button>
									<?php echo business_gravity_get_menu( 'primary' ); ?>
							    </nav>
							</div>
							<span class="alt-menu-icon d-lg-none">
